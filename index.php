                                        ...
                                        <div class="message-widget message-scroll">
                                            ...
                                            <a href="javascript:void(0)">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">(@kumar)</span><span class="userline"></span><span class="badge badge-success badge-pill pull-right">80</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="./assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">(@kumar)</span><span class="userline"></span><span class="badge badge-success badge-pill pull-right">80</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <span class="round">A</span> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">(@kumar)</span><span class="userline"></span><span class="badge badge-success badge-pill pull-right">80</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
